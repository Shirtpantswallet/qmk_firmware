...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	[_LOWER] = KEYMAP(
				 KC_NO,   KC_ACL0,        KC_ACL1,         KC_ACL2, KC_ESC,  KC_NO,   KC_VOLU, KC_7,         KC_8,         KC_9,         KC_NO,           KC_NO,
				 KC_NO,   LGUI_T(KC_DEL), LALT_T(KC_GRV),  KC_LCPO, KC_RSPC, KC_CAPS, KC_MUTE, RSFT_T(KC_4), RCTL_T(KC_5), RALT_T(KC_6), RGUI_T(KC_BSLS), KC_NO,
				 KC_NO,   KC_NO,          LCTL(KC_BSLASH), KC_LBRC, KC_RBRC, KC_NO,   KC_VOLD, KC_1,         KC_2,         KC_3,         KC_SLSH,         KC_NO,
				 KC_LEFT, KC_DOWN,        KC_UP,           KC_RGHT, KC_NO,   KC_NO,   KC_ENT,  KC_0,         KC_COMM,      KC_DOT,       KC_NO,           KC_NO
	),
	[_RAISE] = KEYMAP(
				 DYN_REC_STOP,    KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_NO, KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R, KC_NO,
				 ...
				 KC_NO,           KC_F11,  KC_F12,  KC_F13,  KC_F14,  KC_F15,  KC_NO, KC_NO,   KC_NO,   KC_NO,   KC_NO,   RESET
	)
};
